      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            ...
            from the Faculty of Statistical Studies at Cairo University. I also
            completed a professional Front-End Development course at Route
            Academy, where I built several responsive web projects. My goal is

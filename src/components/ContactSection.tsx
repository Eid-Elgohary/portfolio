  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "ibrahim.manion@example.com",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          {contactInfo.map((info, index) => (
            <Card key={index} className={`bg-gradient-to-br ${info.color} border-purple-700/30 hover:border-purple-500/50 transition-all duration-300`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <Card className="bg-gradient-to-br from-purple-900/40 to-purple-800/20 border-purple-700/30">
            <CardContent className="p-8">
              <h3 className="text-white text-2xl font-bold mb-6">Send Message</h3>
          ...
          <div className="space-y-8">
            <Card className="bg-gradient-to-br from-purple-900/40 to-purple-800/20 border-purple-700/30">
              <CardContent className="p-8">
                <h3 className="text-white text-2xl font-bold mb-4">Let's Work Together</h3>
                <p className="text-gray-300 mb-6">
                  I'm always interested in new opportunities and exciting projects. 
                  Whether you're a startup looking to build your MVP or an established 
                  company needing a fresh perspective, let's discuss how we can work together.
                </p>
                <div className="flex gap-4">
                  {socialLinks.map((social, index) => (
                    <a
                      key={index}
                      href={social.url}
                      className="w-10 h-10 bg-purple-600/30 hover:bg-purple-600/50 rounded-lg flex items-center justify-center text-purple-300 hover:text-white transition-all duration-300"
            ...
            <Card className="bg-gradient-to-br from-purple-900/40 to-purple-800/20 border-purple-700/30">
              <CardContent className="p-8">
                <h3 className="text-white text-xl font-bold mb-4">Quick Response</h3>
